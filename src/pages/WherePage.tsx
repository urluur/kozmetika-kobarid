...
const WherePage: React.FC<{ t: (key: string) => string }> = ({ t }) => {
  return (
    <Container fluid className="p-0 h-100 d-flex flex-column flex-grow-1" style={{ minHeight: 0 }}>
      <Row className="g-0 flex-column flex-md-row w-100 h-100 flex-grow-1" style={{ minHeight: 0 }}>
        <Col xs={12} md={4} className="d-flex flex-column justify-content-center align-items-center align-items-md-start p-4 bg-white h-100 flex-grow-1" style={{ minHeight: 0 }}>
          <div className="w-100">
            <div className="mb-3">
        ...
        <Col xs={12} md={8} className="d-flex align-items-stretch justify-content-center p-0 h-100 flex-grow-1" style={{ minHeight: 0 }}>
